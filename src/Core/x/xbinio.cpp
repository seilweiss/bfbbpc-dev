...
static int32 SkipBytes(FILELOADINFO* fli, int32 fwd);
static int32 ReadSeek(FILELOADINFO* fli, int32 pos);
static void SetBuffer(FILELOADINFO* fli, char* dblbuffer, int32 bufsize);
static void DiscardBuffer(FILELOADINFO* fli);
static int32 ReadRaw(FILELOADINFO* fli, void* data, int32 size, int32 count);
static int32 ReadBytes(FILELOADINFO* fli, char* data, int32 count);
static int32 ReadMShorts(FILELOADINFO* fli, int16* data, int32 count);
static int32 ReadMLongs(FILELOADINFO* fli, int32* data, int32 count);
static int32 ReadMFloats(FILELOADINFO* fli, float32* data, int32 count);
static int32 ReadMDoubles(FILELOADINFO* fli, float64* data, int32 count);
static int32 ReadIShorts(FILELOADINFO* fli, int16* data, int32 count);
static int32 ReadILongs(FILELOADINFO* fli, int32* data, int32 count);
static int32 ReadIFloats(FILELOADINFO* fli, float32* data, int32 count);
static int32 ReadIDoubles(FILELOADINFO* fli, float64* data, int32 count);
static int32 AsyncMRead(FILELOADINFO* fli, int32 offset, char* data, int32 size, int32 n);
static int32 AsyncIRead(FILELOADINFO* fli, int32 offset, char* data, int32 size, int32 n);
static BIO_ASYNC_ERRCODES AsyncReadStatus(FILELOADINFO* fli);
...
static int32 BFD_seek(xFile* bffp, int32 offset, int32 whence, void* xtradata);
static int32 BFD_getLength(xFile* bffp, void* xtradata);
static int32 BFD_startSector(const char* filename);
static void BFD_cb_GCP2_readasync(xFile* bffp);
static int32 BFD_AsyncRead(FILELOADINFO* fli, int32 pos, void* data, int32 size, int32 n, int32);
static BIO_ASYNC_ERRCODES BFD_AsyncReadStatus(FILELOADINFO* fli);
